...
import { buildHomeSessionsStrip } from '../../lib/home-view.ts';
import { backToProjectLink } from '../../lib/session-shell-view.ts';
import { parseSessionShellPayload, type SessionLifecycle } from '../../lib/session-client.ts';
import { describeLifecycle, describeCancelOutcome, SESSION_LIFECYCLE_STATES, type CancelOutcome } from '../../lib/session-lifecycle-client.ts';
import type { SessionIndexRow } from '../../lib/studio-client.ts';
