...
import {
  ...
  cleanupPlanView,
} from '../../lib/session-artifact-view.ts';
import { filePackageTabs, selectFile } from '../../lib/file-package.ts';
import type { RoadmapDraftArtifact, MarkdownDraftArtifact, BrainStructureArtifact, GenerationGalleryArtifact, ContractBuildoutArtifact, CleanupPlanArtifact } from '../../lib/session-client.ts';
import { sessionShellState, selectStage } from '../../lib/session-shell-view.ts';
...
import { dependencyDagView } from '../../lib/dependency-dag.ts';
