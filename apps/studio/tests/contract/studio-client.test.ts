...
import {
  ...
  // see apps/forge/tests/integration/bridge-studio-flows.test.ts's companion route pin). Colocated
...
// `undefined`.
import * as StudioClientModule from '../../lib/studio-client';
import type { Run, TriggerBuilderFields, ShippedTriggerKind, FlowTrigger, Flow } from '../../lib/studio-client';
...
// studio-client.ts's extensionless `from '../../lib/bridge-client'` import. The
...
// (`vi.mock('../../lib/bridge-client.ts', ...)` at this file's top resolves
