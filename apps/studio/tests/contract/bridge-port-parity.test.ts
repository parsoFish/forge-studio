...
import { DEFAULT_BRIDGE_PORT as UI_PORT } from '../../lib/bridge-port.ts';

const FORGE_WATCH_PATH = resolve(__dirname, '../../../forge/forge-watch.ts');
const UI_BRIDGE_PORT_PATH = resolve(__dirname, '..', '..', 'lib', 'bridge-port.ts');
