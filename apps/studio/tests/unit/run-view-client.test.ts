 ...
 * (see `apps/forge/tests/integration/ui-bridge-agent-run.test.ts`'s new "no run directory at all"
...
import { resolveRunDetailFromResponse, type RunDetail } from '../../lib/run-view-client.ts';
