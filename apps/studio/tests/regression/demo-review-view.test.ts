...
import { regionDefaultOpen, summarizeReview, REGION_COLLAPSE_THRESHOLD } from '../../lib/demo-review-view.ts';
import type { ReviewComment } from '../../lib/review-comments-client.ts';
