 ...
 * cli/ at runtime (see `apps/studio/lib/session-lifecycle-client.ts`'s and
 * `apps/studio/lib/session-client.ts`'s own headers for the same stated
 ...
 * `apps/studio/lib/authoring-package-shape.ts` /
 ...
 * names, `apps/studio/tests/contract/page-exports-whitelist.test.ts` enforces it) seeds
