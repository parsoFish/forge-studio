  ...
  return (
    <div data-section="demo-comparison" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {/* Intent & Outcome — foregrounded per-AC evaluation (MVUS req b).
          The per-AC VERDICT moved to the review panel with spec §5 item 5: it is
          the read-only reviewer's judgment, and the demo is the evidence it
          judges — a bundle that scored itself was the self-grading loop. What
          stays here is the criteria the change was decomposed against. */}
      ...
      {/* Acceptance criteria — the list the initiative was decomposed against.
          Their VERDICTS live on the review panel (`data-section="ac-verdicts"`). */}
...
/** Shape-aware checkpoints heading — mirrors packages/stations/demo-model.ts so the in-UI demo
