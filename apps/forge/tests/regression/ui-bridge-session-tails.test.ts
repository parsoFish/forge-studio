 ...
 *
 * Mirrors `apps/forge/tests/integration/ui-bridge-architect.test.ts`'s own "GET /api/architect/
 ...
 *  sibling `apps/forge/tests/integration/ui-bridge-kb-cleanup.test.ts` AT-3/AT-4/AT-5 already prove
 ...
 *  — the exact fixture shape apps/forge/tests/integration/ui-bridge-architect.test.ts's own
