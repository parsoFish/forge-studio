 ...
 * route (mirrors the fixture idiom of apps/forge/tests/integration/bridge-studio-flows.test.ts).
 *
...
// ---------------------------------------------------------------------------
// Fixture helpers (mirrors apps/forge/tests/integration/bridge-studio-flows.test.ts)
// ---------------------------------------------------------------------------
