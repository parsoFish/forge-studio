 ...
 * point test was added — see `apps/forge/tests/regression/studio-lint-guards-migration.test.ts`'s C4).
 ...
 * `apps/forge/tests/regression/studio-lint-guards-migration.test.ts`'s own stated reason: both need
 ...
 * `apps/forge/tests/unit/studio-lint.test.ts` / `apps/forge/tests/regression/studio-lint-guards-migration.test.ts`
 ...
 *  — mirrors apps/forge/tests/unit/studio-lint.test.ts's `validSkillMd`. */
 ...
 *  mirrors apps/forge/tests/regression/studio-lint-guards-migration.test.ts's `validGuardsCatalogYaml`. */
 ...
 *  apps/forge/tests/unit/studio-lint.test.ts's `buildValidRoot`, but seeds the real 9-id
