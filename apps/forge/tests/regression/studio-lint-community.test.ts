 ...
 * `apps/forge/tests/regression/studio-lint-hooks.test.ts`'s own stated reason: both need the entry
 * point directly. Fixture conventions (`tmpRoot`, `seedValidProject`,
 * `buildBaseRoot`) are copied from `apps/forge/tests/regression/studio-lint-hooks.test.ts` rather
 * than reinvented.
 *
 ...
 *  apps/forge/tests/regression/studio-lint-hooks.test.ts's `buildBaseRoot`. W6-CR-1: community
