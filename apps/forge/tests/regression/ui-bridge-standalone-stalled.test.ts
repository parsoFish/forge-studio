 ...
 *
 * RUN: node --experimental-strip-types --test apps/forge/tests/regression/ui-bridge-standalone-stalled.test.ts
 */
...
import { DEFAULT_STALL_CEILING_MS } from '@forge/sessions';
