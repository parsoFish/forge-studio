 ...
 * `composition/guard-unknown`; `apps/forge/tests/regression/studio-lint-guards-migration.test.ts`'s
 * C4 for the second).
 *
 ...
 * SHAPE (`@forge/agents`'s `['composition/hooks',
 ...
 * convention, see apps/forge/tests/regression/studio-lint-guards-migration.test.ts vs
 * apps/forge/tests/regression/studio-lint-hooks.test.ts both hand-declaring the same catalog shape). */
