 ...
 *
 * RUN: node --test --experimental-strip-types apps/forge/tests/regression/studio-provenance.test.ts
 */
...
// ---------------------------------------------------------------------------
// Fixture helpers (mirrors apps/forge/tests/integration/bridge-studio.test.ts / cli/bridge-studio-kbs.test.ts)
// ---------------------------------------------------------------------------
