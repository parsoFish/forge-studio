 ...
 * `apps/forge/tests/integration/ui-bridge-agent-run-ceiling.test.ts` section (D) — reimplemented
 ...
 *
 * RUN: node --test --experimental-strip-types apps/forge/tests/integration/ui-bridge-cost-ceiling-enforceable.test.ts
 */
