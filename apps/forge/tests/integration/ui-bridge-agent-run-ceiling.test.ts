 ...
 *
 *   node --test --experimental-strip-types apps/forge/tests/integration/ui-bridge-agent-run-ceiling.test.ts
 *
 ...
 * apps/forge/tests/integration/ui-bridge-agent-run-materials.test.ts's identical technique — reused
