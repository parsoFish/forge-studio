 ...
 * / `apps/forge/tests/integration/ui-bridge-kb-cleanup.test.ts`'s own idioms, reusing their fixture
 ...
 *  mirrors `apps/forge/tests/integration/ui-bridge-kb-cleanup.test.ts`'s own `rawPost` exactly. */
...
test('SEC-9: oversized body (> 1 MiB) -> rejected (never 200); session untouched', async () => {
  // Mirrors apps/forge/tests/integration/bridge-studio-write.test.ts's "PUT with oversized body ->
