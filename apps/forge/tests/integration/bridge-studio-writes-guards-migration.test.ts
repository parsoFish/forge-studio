 ...
 *
 * Mirrors `apps/forge/tests/integration/bridge-studio-write.test.ts`'s existing harness conventions
 ...
 * `apps/forge/tests/regression/studio-lint-guards-migration.test.ts`'s "A3 SUPERSEDED" paragraph —
