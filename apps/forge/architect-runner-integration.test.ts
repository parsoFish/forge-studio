      ...
      initiatives: [
        {
          ...
          iteration_budget: 4,
          cost_budget_usd: 6, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
        ...
        initiatives: [
          {
            ...
            title: 'Compact flag',
            iteration_budget: 3,
            cost_budget_usd: 2, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
      ...
      const structured = !isDraft
        ...
        : isRetry
          ? {
              vision: 'Dark mode that follows the OS.',
              initiatives: [
                { slug: 'dark-mode-toggle', title: 'Dark mode toggle', iteration_budget: 4, cost_budget_usd: 6, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
            ...
            initiatives: [
              {
                ...
                title: 'Green the CI',
                iteration_budget: 3,
                cost_budget_usd: 4, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
              ...
              },
              {
                ...
                iteration_budget: 5,
                cost_budget_usd: 8, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
          ...
          initiatives: [
            {
              ...
              title: 'Dark mode',
              iteration_budget: 3,
              cost_budget_usd: 5, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
        ...
        initiatives: [
          {
            ...
            title: 'Spec test',
            iteration_budget: 2,
            cost_budget_usd: 1, class: 'code', acceptance_criteria: [{ given: 'the drafted scope', when: 'the work merges', then: 'the outcome is observable' }],
