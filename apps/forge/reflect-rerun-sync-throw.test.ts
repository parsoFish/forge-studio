 ...
 *
 * It sits FLAT here on purpose: M6-C's re-bucket moves it into
 * `tests/regression/` with the rest of this tree's tests, and writing it at
 * the bucketed path first would have made this fix depend on that move.
 *
