 ...
 * `runAdversarialReview` (`packages/factory/phases/adversarial-review.ts`) passes
 ...
 *   UPDATE_SNAPSHOT=1 node --experimental-strip-types --test packages/factory/tests/contract/adversarial-review-spawn-capture.test.ts
