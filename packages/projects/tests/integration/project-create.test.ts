...
test('(RED) [SEC-03 round 3] scaffoldGreenfieldProject leaves NO project directory behind when seedProjectBrain rejects a planted symlink', () => {
  ...
  try {
    ...
    // drive; see apps/forge/tests/integration/bridge-studio-write.test.ts / cli/bridge-studio-
...
// as its OWN second containment root — see apps/forge/tests/integration/bridge-studio-write.test.ts's
