 ...
 *
 * Both cases moved here from `apps/forge/tests/contract/id-rule.test.ts` (M4-knowledge s5). That file
 ...
 * W7A4-04 red-pin stays in `apps/forge/tests/contract/id-rule.test.ts` asserting on
