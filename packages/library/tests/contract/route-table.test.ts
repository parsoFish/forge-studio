...
const TABLE = libraryRoutes({ agentFacts: fixtureAgentFacts('/nonexistent-forge-root'), isSdkAvailable: () => false, flowSource: fixtureFlowSource, authoringSession: inertAuthoringSession });
