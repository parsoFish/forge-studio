/**
 * Acceptance tests for packages/library/studio/community-index.ts (R3-07-F1/F2,
...
import { listCatalogConnections } from '../../studio/connection-library.ts';
import { installSkillPackage, approveSkillDraft } from '../../studio/skill-install.ts';
import { hookDir, hookYamlPath } from '../../studio/hook-library.ts';
import { scanHookScript } from '../../studio/hook-scan.ts';
