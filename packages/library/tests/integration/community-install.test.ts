...
import { hookRunState, isHookRunnable, readHookApprovalLedger, approveHook } from '../../studio/hook-approval-ledger.ts';
import { vendoredPackageDir } from '../../studio/community-index.ts';
...
import { communityItem, listCommunityIndex, readVendoredPackage } from '../../studio/community-index.ts';
