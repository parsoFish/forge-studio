 ...
 * `lintSkillToolFence`. Mirrors `apps/forge/tests/regression/studio-lint-hooks.test.ts`'s own
 ...
 * `apps/forge/tests/regression/studio-lint-hooks.test.ts` rather than reinvented.
 */
...
// test in apps/forge/tests/unit/studio-lint.test.ts (which would also catch it, but wouldn't
