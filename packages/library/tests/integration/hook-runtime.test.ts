 ...
 * `Cannot find module '../../studio/hook-runtime.ts'` on import. Do not stub the module
...
import { buildHookChildEnv, detectUndeclaredEnvRefs, runHookScript, buildHookApprovalGateView, HookRunError, type HookRunResult } from '../../studio/hook-runtime.ts';
