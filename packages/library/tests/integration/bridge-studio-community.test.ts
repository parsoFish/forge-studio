 ...
 * proves the ROUTE surface refuses one; `packages/library/tests/contract/community-no-trust-decisions.test.ts`
...
// packages/library/tests/contract/connections-no-authoring.test.ts's bridge-refusal half).
// ---------------------------------------------------------------------------
