...
// in the sibling `apps/forge/tests/integration/ui-bridge-agent-run-ceiling.test.ts`, because both
...
//     apps/forge/tests/integration/ui-bridge-agent-run-ceiling.test.ts, since `forge agent dispatch
...
// derived `state` token) is pinned in apps/forge/tests/integration/ui-bridge-agent-run-ceiling.test.ts.
