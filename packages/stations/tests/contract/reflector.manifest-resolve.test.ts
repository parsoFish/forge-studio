 ...
 * `packages/stations/phases/reflector.ts`'s `resolveCurrentManifestPath` (~line
...
import { REFLECTION_LOST_EVENT, type CycleInput } from '@forge/flows';
...
// in `runReflector` (packages/stations/phases/reflector.ts ~line 171-198) must
