/**
 * Tests for packages/stations/phases/release-finalize.ts (WS-A · final-loop).
 *
 * Covers:
...
import { runReleaseFinalize, type RunReleaseFinalizeInput } from '../../phases/release-finalize.ts';
