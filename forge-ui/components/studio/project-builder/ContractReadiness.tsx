  ...
  return (
    <div>
      ...
      >
        ...
        {/* Preflight results from bridge */}
        {preflight && preflight.clauses.length > 0 && (
          <div style={{ marginTop: 8, paddingTop: 8, borderTop: '1px solid var(--line)' }}>
            <div style={{ fontSize: 10, fontFamily: 'var(--font-display)', fontWeight: 600, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--faint)', marginBottom: 6 }}>forge preflight</div>
