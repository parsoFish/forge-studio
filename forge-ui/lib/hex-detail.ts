 ...
 * work-item) selects it; a side drawer then shows that hex's definition +
 * a scoped activity tracker.
 *
 ...
 *
 * The feature tier has been removed (refocus: initiative→WI directly).
 */
