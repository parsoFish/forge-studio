...
- [`apps/forge/ui-bridge-agent-run-ceiling.test.ts`](../../../apps/forge/ui-bridge-agent-run-ceiling.test.ts) — the sibling that inherited the precondition and could not pass in CI.
