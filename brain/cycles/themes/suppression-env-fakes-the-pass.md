...
- [`packages/agents/run-agent-ceiling.test.ts`](../../../packages/agents/run-agent-ceiling.test.ts) — the `withoutSpawnSuppressionEnv()` pattern, applied 15 times.
