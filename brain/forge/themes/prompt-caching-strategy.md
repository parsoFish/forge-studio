...
description: Structuring system prompts with stable content first achieved 92% cache hits in v1 Cycle 3 (903M reads vs 363K fresh). The single largest cost lever in the token budget.
category: pattern
keywords: [prompt-caching, cache-hit-rate, stable-prefix, 92-percent, cost-reduction, cache-control]
created_at: 2026-05-04T19:30:00Z
updated_at: 2026-05-04T19:30:00Z
related_themes: [cost-aware-model-routing, claude-agent-sdk, conditional-core-values]
---
...
- [Theme: Cost-aware model routing](./cost-aware-model-routing.md) — the other major cost lever.
- [Theme: Claude Agent SDK](./claude-agent-sdk.md) — how `cache_control` is exposed.
- [Theme: Conditional core values](./conditional-core-values.md) — keeps the stable prefix compact.
