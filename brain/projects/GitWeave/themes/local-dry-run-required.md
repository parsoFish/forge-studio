...
description: Every change-introducing CLI must support a local dry-run. "Trust the agent, run the apply" is forbidden — Terraform-style plan-then-apply is the discipline.
category: pattern
keywords: [gitweave, dry-run, plan, terraform, local-reproducibility, gw-plan, change-discipline]
...
- [Theme: Quality gates orchestrator-verified](../../../forge/themes/quality-gates-orchestrator-verified.md) — sibling discipline.
