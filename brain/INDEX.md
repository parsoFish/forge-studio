...
- **Brain 1 (forge-dev):** forge code + ADRs + engineering notes (decision/reference themes) at `brain/forge-dev/` (**15 theme pages**).
- **Brain 2 (cycles):** cycle-derived patterns, antipatterns, operations, raw archives at `brain/cycles/` (**130 theme pages**, **74 raw cycle archives**).
- **Brain 3 (per project):** project brain lives inside each project repo at `projects/<name>/brain/` (**20 total project-level theme pages** across 1 active project(s)).
