...
**Status:** Generated by `forge brain index --write`. The brain holds **70 forge-level theme pages**, **38 project-level theme pages** (across 7 sub-wikis), **48 raw sources** (`_raw/docs/`, `_raw/web/`, `_raw/v1-wiki/`, `_raw/cycles/`, `_raw/projects/`), and a benchmark question set. See [`docs/seeding-plan.md`](../docs/seeding-plan.md) and [`log.md`](./log.md).
