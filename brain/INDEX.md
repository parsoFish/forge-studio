...
- **Brain 1 (forge-dev):** forge code + ADRs + engineering notes (decision/reference themes) at `brain/forge-dev/` (**30 theme pages**).
- **Brain 2 (cycles):** cycle-derived patterns, antipatterns, operations, raw archives at `brain/cycles/` (**153 theme pages**, **84 raw cycle archives**).
- **Brain 3 (per project):** project brain is forge-owned and **central** ([ADR 035](../docs/decisions/035-forge-owned-central-artifacts.md)) at `brain/projects/<name>/` (**199 total project-level theme pages** across 5 active project(s)).
