...
- **Brain 2 (cycles):** cycle-derived patterns, antipatterns, operations, raw archives at `brain/cycles/` (**58 theme pages**, **18 raw cycle archives**).
- **Brain 3 (per project):** project brain lives inside each project repo at `projects/<name>/brain/` (**57 total project-level theme pages** across 3 active project(s)).
