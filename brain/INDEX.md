...
- **Brain 1 (forge-dev):** forge code + ADRs + engineering notes (decision/reference themes) at `brain/forge-dev/` (**29 theme pages**).
- **Brain 2 (cycles):** cycle-derived patterns, antipatterns, operations, raw archives at `brain/cycles/` (**152 theme pages**, **79 raw cycle archives**).
