...
- **Brain 1 (forge-dev):** forge code + ADRs + engineering notes (decision/reference themes) at `brain/forge-dev/` (**11 theme pages**).
- **Brain 2 (cycles):** cycle-derived patterns, antipatterns, operations, raw archives at `brain/cycles/` (**57 theme pages**, **25 raw cycle archives**).
- **Brain 3 (per project):** project brain lives inside each project repo at `projects/<name>/brain/` (**79 total project-level theme pages** across 3 active project(s)).
