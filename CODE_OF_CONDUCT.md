...
This project has a single maintainer ([@parsoFish](https://github.com/parsoFish))
and no public mailing list or personal contact address is monitored for
conduct reports. Instances of abusive, harassing, or otherwise unacceptable
behavior can be reported privately through **GitHub's private vulnerability
reporting flow on this repository** (Security tab → *Report a vulnerability*
— see [SECURITY.md](./SECURITY.md) for the same channel used for security
disclosures). This opens a private report visible only to the maintainer.
