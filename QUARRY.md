...
| `flows` | 82 | 23,373 | **23,173** | ratified 23,173 — row 86 post-merge worktree prune, path-guarded (forge-8vfn.8.1.3), lane-ratified under ruling 666; see git history for prior raises. |
...
| packages/flows/finalize-merged.ts | flows | verbatim | 510 |
