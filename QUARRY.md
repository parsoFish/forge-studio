...
| packages/projects/preflight.ts | projects | pruned | 1110 |
...
| packages/projects/project-config.ts | projects | verbatim | 970 |
| packages/projects/project-create.ts | projects | verbatim | 379 |
...
| packages/agents/skill-path.ts | agents | verbatim | 373 |
| packages/agents/spawn-env.ts | agents | verbatim | 181 |
