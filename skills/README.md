...
> **Scope 2 — cycles / agents / flows** ([repo map](../docs/explanation/architecture.md)). Every "agent" in forge is a Claude Code skill. See [ADR 003](../docs/decisions/003-skills-not-self-baked-agents.md).
