...
export const ALLOWLIST = [
  ...
  { file: 'cli/ui-bridge.ts', line: 3586, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3587, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3595, sink: 'writeFileSync',
