...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 160, sink: 'existsSync',
    reason: 'PROJECTROOT-GUARDED: checkContractArtifactContainment — boolean "does .gitignore already exist" probe, immediately followed by resolveGuardedPath(projectRoot, [\'.gitignore\']) (which rejects a symlinked/dangling leaf) before ANY write is attempted; projectRoot itself was validated by isContainedProjectRepoPath at the route. Same idiom as the .forge/project.json probe two blocks up (W7-FIX-B-PROJ: .gitignore joined the scaffold write set).' },
  { file: 'cli/bridge-studio-writes.ts', line: 280, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 1441, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 1506, sinks: ['existsSync', 'mkdirSync'],
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 152, sink: 'existsSync',
