...
export const ALLOWLIST = [
  ...
  { file: 'packages/projects/bridge-studio-project-onboard.ts', line: 285, sink: 'existsSync',
  ...
  { file: 'packages/projects/bridge-studio-project-onboard.ts', line: 352, sinks: ['existsSync', 'mkdirSync'],
