...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio.ts', line: 428, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio.ts', line: 430, sink: 'readFileSync',
    reason: 'LOG-READ: as line 428 — internal preflight-fix event log only (symlink-blind residual disclosed in openConcerns). (Line-drift remap from 413. Further remap from 420 — forge-3oq, same cause as the row above. Further remap from 428 — W6-RV-1, same +2 import cause as the row above.)' },
