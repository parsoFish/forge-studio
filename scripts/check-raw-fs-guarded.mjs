...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio.ts', line: 524, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio.ts', line: 654, sink: 'readFileSync',
  ...
  { file: 'cli/bridge-studio.ts', line: 633, sink: 'existsSync',
  ...
  // ---- GUARD-NEXT: route the FULL path (incl. leaf) through the guard ----
  { file: 'cli/bridge-studio.ts', line: 1438, sink: 'readFileSync',
