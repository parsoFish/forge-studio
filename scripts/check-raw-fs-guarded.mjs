...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 1102, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 1167, sinks: ['existsSync', 'mkdirSync'],
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 144, sink: 'existsSync',
