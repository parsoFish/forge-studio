...
export const ALLOWLIST = [
  ...
  { file: 'cli/ui-bridge.ts', line: 3430, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3431, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3439, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3476, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3477, sink: 'writeFileSync',
    reason: 'EXCLUSIVE-CREATE: authoring status.json write with flag `wx` (O_EXCL) — never follows an existing symlink; parent sessionDir just exclusively created (line 3476), sessionId SAFE_ID_RE-gated. (Line-drift remap from 3453 — R4-21 phase 2, WI-2, same cause as the row above; the write itself now also includes `prompt` in the JSON payload, same sink, same guard.)' },
  { file: 'cli/ui-bridge.ts', line: 3482, sink: 'writeFileSync',
    reason: 'EXCLUSIVE-CREATE: authoring prompt.md write with flag `wx` (O_EXCL) — same exclusive-create discipline as line 3477. (Line-drift remap from 3458 — R4-21 phase 2, WI-2, same cause as the row above.)' },
  { file: 'cli/ui-bridge.ts', line: 4040, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4138, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4192, sink: 'existsSync',
