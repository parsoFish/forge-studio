...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 220, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 1486, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 1553, sinks: ['existsSync', 'mkdirSync'],
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 207, sink: 'existsSync',
  ...
  // ---- RETAIN: contained by a mechanism the scanner can\'t see (confirm next stage) ----
  { file: 'cli/ui-bridge.ts', line: 2708, sink: 'mkdirSync',
