...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 1023, sink: 'mkdirSync',
    reason: 'CREATE-LITERAL-SUBDIR: as line 1022, literal `_raw` subdir under the freshly-created guarded kbDir. (Line-drift remap from 1158 — forge-2am.)' },
