...
export const ALLOWLIST = [
  ...
  // ---- orchestrator/architect-runner.ts ----
  { file: 'orchestrator/architect-runner.ts', line: 1397, sink: 'existsSync',
  ...
  { file: 'orchestrator/architect-runner.ts', line: 1399, sink: 'readFileSync',
  ...
  { file: 'orchestrator/architect-runner.ts', line: 1408, sink: 'writeFileSync',
  ...
  { file: 'orchestrator/architect-runner.ts', line: 1586, sink: 'existsSync',
  ...
  { file: 'orchestrator/architect-runner.ts', line: 1588, sink: 'readFileSync',
