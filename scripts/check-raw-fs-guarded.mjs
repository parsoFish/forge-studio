...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio.ts', line: 634, sink: 'readFileSync',
  ...
  { file: 'cli/bridge-studio.ts', line: 621, sink: 'existsSync',
  ...
  // ---- GUARD-NEXT: route the FULL path (incl. leaf) through the guard ----
  { file: 'cli/bridge-studio.ts', line: 1418, sink: 'readFileSync',
