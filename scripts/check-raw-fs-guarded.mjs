...
export const ALLOWLIST = [
  ...
  // W8-A3 (flows-37, 2026-08-23) — LINE-DRIFT REMAP, +17 total, recorded once
  // here rather than thirteen times inline. Two edits in the same region of
  // `cli/ui-bridge.ts` shifted every later line: `POST /api/flows/:id/run` gained
  // the `confirmRepoint` body read and a wrapped httpStatus ternary (+7, ~:2875),
  // and `POST /api/initiatives/:id/plan` gained the same forward after
  // adversarial review found it was a third, ungated door onto a repoint (+10,
  // ~:2830). The thirteen rows below moved 3106→3123, 3107→3124, 3545→3562,
  // 3546→3563, 4721→4738, 4722→4739, 4730→4747, 4773→4790, 4774→4791,
  // 4790→4807, 5362→5379, 5568→5585, 5864→5881. Same sinks, same guards, no
  // audit changed — re-verified by a direct `node scripts/check-raw-fs-guarded.mjs`
  // run (PASS, 70 allowlisted residuals, the same count this file carried at
  // parsoFish/main a414a423).
  ...
  { file: 'cli/ui-bridge.ts', line: 3124, sink: 'openSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3563, sink: 'openSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3562, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4738, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4739, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4790, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4791, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4807, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5379, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5585, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5881, sink: 'existsSync',
