...
export const ALLOWLIST = [
  ...
  // ---- cli/ui-bridge.ts ----
  { file: 'cli/ui-bridge.ts', line: 464, sink: 'existsSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 789, sink: 'existsSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 1141, sink: 'existsSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 1144, sink: 'readdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4038, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4039, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4047, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4090, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4091, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4107, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4673, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4849, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5106, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 143, sink: 'existsSync',
    reason: 'RETAIN (boolean probe — MUST NOT guard): checkContractArtifactContainment(projectRoot) — projectRoot isContainedProjectRepoPath-validated at the route (line 835, per the 854/919 rows) before this Phase-1 checker; existsSync(join(projectRoot, ".forge","project.json")) is a boolean gate that RUNS resolveGuardedPath when the file is ABSENT (no bytes flow). Guarding an idempotent existence probe would false-reject; newly visible only because projectRoot is now a dir-shaped param. (Line-drift remap from 141 -- W7-B4 WI-1 (checkContractArtifactContainment split the two existsSync probes across lines 140/143, +2 lines; the duplicate 141 row this split orphaned is deleted rather than remapped -- only the leaf-append probe at 143 is reported); same function, same probe, unchanged -- re-verified via a direct `node scripts/check-raw-fs-guarded.mjs` run.)' },
  ...
  // ---- RETAIN: contained by a mechanism the scanner can\'t see (confirm next stage) ----
  { file: 'cli/ui-bridge.ts', line: 2233, sink: 'mkdirSync',
