...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 880, sink: 'existsSync',
  ...
  { file: 'cli/bridge-studio-writes.ts', line: 945, sinks: ['existsSync', 'mkdirSync'],
  ...
  { file: 'cli/ui-bridge.ts', line: 4103, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4163, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4735, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4911, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5174, sink: 'existsSync',
  ...
  // ---- GUARD-NEXT: route the FULL path (incl. leaf) through the guard ----
  { file: 'cli/bridge-studio.ts', line: 1454, sink: 'readFileSync',
