...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 210, sink: 'mkdirSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 241, sink: 'mkdirSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 221, sink: 'appendFileSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 248, sink: 'appendFileSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 1484, sink: 'mkdirSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 1485, sink: 'mkdirSync',
  ...
  // ---- GUARD-NEXT: route the FULL path (incl. leaf) through the guard ----
  { file: 'cli/bridge-studio.ts', line: 1722, sink: 'readFileSync',
