...
export const ALLOWLIST = [
  ...
  // W8-A3 (flows-37, 2026-08-23) — LINE-DRIFT REMAP, +7, recorded once here
  // rather than thirteen times inline. `POST /api/flows/:id/run` gained the
  // `confirmRepoint` body read (6 lines of comment + 1 of code, ~:2875) and its
  // httpStatus ternary was wrapped onto a second line (~:2894), shifting every
  // cli/ui-bridge.ts line after that point. The thirteen rows below moved
  // 3106→3113, 3107→3114, 3545→3552, 3546→3553, 4721→4728, 4722→4729,
  // 4730→4737, 4773→4780, 4774→4781, 4790→4797, 5362→5369, 5568→5575,
  // 5864→5871. Same sinks, same guards, no audit changed — re-verified by a
  // direct `node scripts/check-raw-fs-guarded.mjs` run (PASS, 70 allowlisted
  // residuals, the same count this file carried at parsoFish/main a414a423).
  ...
  { file: 'cli/ui-bridge.ts', line: 3114, sink: 'openSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3553, sink: 'openSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 3552, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4728, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4729, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4737, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4780, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4781, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 4797, sink: 'writeFileSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5369, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5575, sink: 'mkdirSync',
  ...
  { file: 'cli/ui-bridge.ts', line: 5871, sink: 'existsSync',
