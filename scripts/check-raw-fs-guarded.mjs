...
export const ALLOWLIST = [
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 214, sink: 'mkdirSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 245, sink: 'mkdirSync',
  ...
  // ---- orchestrator/interactive-session.ts ----
  { file: 'orchestrator/interactive-session.ts', line: 768, sink: 'existsSync',
  ...
  { file: 'orchestrator/interactive-session.ts', line: 770, sink: 'readFileSync',
  ...
  { file: 'orchestrator/interactive-session.ts', line: 787, sink: 'writeFileSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 225, sink: 'appendFileSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 252, sink: 'appendFileSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 1507, sink: 'mkdirSync',
  ...
  { file: 'cli/bridge-studio-kbs.ts', line: 1508, sink: 'mkdirSync',
