...
import { applyFence, starterAgentSlugs, describeFence, fenceBreaches, fixturePathsFor, parseGitPorcelain, productFixturePathsFor, sweepStoryResidue, sweepProductFixtures } from './sweep.mjs';
...
// Deleting a story's GitHub remote (bead `forge-8vfn.6.11.2`, ruling 255) moved
// to `sweep-remotes.test.ts` when `sweepStoryRemotes`/`describeRemoteSweep`
// split out of `sweep.mjs` into `sweep-remotes.mjs` (T1 ruling 1350's fork
// brief, ruling 492: an edit to this file owes it a split, never a baseline).
