...
- **Supersedes / amends:** amends the "PR-as-feedback-surface" position of the
  ...
  screens) and the existing demo model (`packages/factory/demo-model.ts:DemoModel`).
- **Update 2026-06-20 (F4 / DEC-4):** the demo OUTPUT is consolidated to a
  ...
  **retired**; the shared schema types moved to `packages/factory/demo-types.ts`. References
