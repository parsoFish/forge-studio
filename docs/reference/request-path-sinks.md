...
| — not request-derived, new in M5-B (the minted-remote manifest, bead `forge-8vfn.6.11.29`; the starter presentation manifest, bead `forge-8vfn.6.11.4`) | 2 |
